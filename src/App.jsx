...
const STEPS = { PRODUCTS: 'products', CART: 'cart', CHECKOUT: 'checkout', PROFILE: 'profile', ORDERS_HISTORY: 'orders_history', HELP: 'help', ORDER_DETAIL: 'order_detail' };
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 pb-24">
      ...
      {(step === STEPS.PRODUCTS || step === STEPS.CART || step === STEPS.PROFILE || step === STEPS.ORDERS_HISTORY || step === STEPS.HELP) && (
